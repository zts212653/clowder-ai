...
export const callbackTools = [
  ...
  defineCanonicalTool({
    ...
    description:
      ...
      // Orthogonal to this redesign and owned by review-completion routing: rewriting this
      // description wholesale dropped it, and check:review-completion-routing is what noticed.
  ...
  defineCanonicalTool({
    ...
    description:
      'Track one GitHub issue: route every new external comment back to this registration thread, and tell you once when the issue is closed. ' +
      ...
      'GOTCHA: give only the repo and number (plus an optional next-step reminder) — an issue has no include/exclude, both of its surfaces are on. ' +
      'Human and bot comments both notify; your own comments do not. There is no deadline, but tracking is not endless either: closing the issue delivers one terminal notice and ENDS the tracking, so a reopen needs a fresh registration. Explicit unregister_tracking is the only other ending.',
