/**
 * F057-C2: Detect co-creator (@co-creator / @co-creator / @co-creator / configured) mention at line start.
 *
 ...
 * (e.g. @co-creator123, @co-creator123) but allow CJK text (e.g. @co-creator请看, @co-creator请看).
 *
