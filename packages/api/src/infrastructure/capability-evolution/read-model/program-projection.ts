...
import type { EvolutionPreparationProjectionV1 } from '../program-preparation-contract.js';
...
export interface EvolutionProgramProjectionV1 extends EvolutionProgramStateV1 {
  /** Optional live context attached only by an authenticated read route. Not part of the event state. */
  origin?: EvolutionProgramOriginV1;
  /** Exact-read-only join of Program refs, F117 bodies, and F167 invocation liveness. */
  preparation?: EvolutionPreparationProjectionV1;
  drafts: {
