...
export const ENV_VARS: EnvDefinition[] = [
  ...
  },
  {
    ...
    defaultValue: '(未设置)',
    description: 'Anthropic builtin provider 的可选 API 基地址',
    category: 'cli',
    sensitive: false,
    hubVisible: false,
  },
  {
    ...
    defaultValue: '(未设置)',
    description: 'OpenAI builtin provider 的可选 API 基地址',
    category: 'cli',
    sensitive: false,
    hubVisible: false,
  },
  {
    ...
    defaultValue: '(未设置)',
    description: 'OpenAI API 基地址的兼容环境变量',
    category: 'cli',
    sensitive: false,
    hubVisible: false,
  },
  {
    ...
    defaultValue: '(未设置)',
    description: 'Gemini builtin provider 的可选 API 基地址',
    category: 'cli',
    sensitive: false,
    hubVisible: false,
  },
  {
    name: 'CAT_CAFE_KIMI_BASE_URL',
    defaultValue: '(未设置)',
    description: 'Clowder Kimi provider 的可选 API 基地址',
    category: 'cli',
    sensitive: false,
    hubVisible: false,
  },
  {
    name: 'KIMI_BASE_URL',
    defaultValue: '(未设置)',
    description: 'Kimi provider 的兼容 API 基地址',
    category: 'cli',
    sensitive: false,
    hubVisible: false,
  },
  {
    name: 'CAT_CAFE_OC_BASE_URL',
    defaultValue: '(未设置)',
    description: 'Clowder OpenCode provider 的可选 API 基地址',
    category: 'cli',
    sensitive: false,
    hubVisible: false,
  },
  {
    ...
    defaultValue: '(未设置)',
    description: 'OpenCode provider 的兼容 API 基地址',
    category: 'cli',
    sensitive: false,
    hubVisible: false,
  },
