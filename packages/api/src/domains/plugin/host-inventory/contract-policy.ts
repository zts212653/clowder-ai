...
export const PLUGIN_CONTRACT_PACKAGE_VERSION = '0.1.0-beta.22' as const;
...
export const PREVIOUS_PLUGIN_MANIFEST_CONTRACT_VERSIONS = ['0.1.0-beta.20', '0.1.0-beta.21'] as const;
