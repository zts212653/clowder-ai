...
if #KEYS < 12 or #ARGV ~= 20 then return 'INVALID_ARGUMENTS' end
local settledKeyIndex = tonumber(ARGV[20]) or 0
if settledKeyIndex < 12 or settledKeyIndex > #KEYS then return 'INVALID_ARGUMENTS' end
