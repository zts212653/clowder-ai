...
describe('GET /api/threads/:id/cats', () => {
  ...
  it('projects the exact no-mention fallback shared by message ingress and Queue admission', async () => {
  ...
  it('uses null instead of guessing when canonical conversation routing has no fallback', async () => {
