 ...
 * until a pointer or keyboard actually asks for it.
 *
...
function readToolbarState() {
  ...
  const bubble = document.querySelector('[data-testid="f294-density-bubble"]');
...
test('message actions occupy no resting layout and stay unpainted until asked for', { timeout: 90_000 }, async () => {
  ...
  try {
    ...
    await page.getByTestId('f294-density-bubble').hover();
