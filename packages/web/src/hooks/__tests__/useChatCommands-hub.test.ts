/**
 * F12→F179: useChatCommands hub integration tests
 * Tests /help and /config via real processCommand invocation.
 * After F179, /help and /config navigate to /settings via window.location.assign.
 */
...
describe('useChatCommands hub commands (F179)', () => {
  beforeEach(() => {
