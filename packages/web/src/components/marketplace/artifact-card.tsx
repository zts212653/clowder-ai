...
export function ArtifactCard({
  ...
  return (
    <button
      ...
      className="w-full rounded-xl border border-cafe-border bg-[var(--console-card-bg)] p-4 text-left shadow-sm transition-colors hover:border-conn-purple-ring hover:shadow-md"
    >
