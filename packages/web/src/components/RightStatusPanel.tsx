...
export interface RightStatusPanelProps {
  ...
  /** Optional width override (px). When set, replaces the default w-72 class. */
  width?: number;
}
...
export function RightStatusPanel({
  ...
  return (
    <aside
      className={`hidden lg:flex border-l border-owner-light bg-white/90 px-4 py-4 flex-col gap-4 overflow-y-auto flex-shrink-0 ${width ? '' : 'w-72'}`}
