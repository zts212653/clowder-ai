...
const iconPaths: Record<string, string> = {
  ...
  'eye-off':
    'M3 3l18 18M10.6 5.2A10.6 10.6 0 0112 5c6.5 0 10 7 10 7a16.9 16.9 0 01-3 4.1M6.6 6.6C3.6 8.5 2 12 2 12s3.5 7 10 7a10.5 10.5 0 004.1-.8M9.9 9.9a3 3 0 004.2 4.2',
  expand: 'M8 3H3v5m13-5h5v5M8 21H3v-5m13 5h5v-5',
  contract: 'M8 8H3V3m13 5h5V3M8 16H3v5m13-5h5v5',
  resize: 'M8 4H4v4m12-4h4v4M8 20H4v-4m12 4h4v-4M9 15l6-6',
  ...
  'bell-off': 'M13.73 21a2 2 0 0 1-3.46 0M18.63 13A17.9 17.9 0 0 0 18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h14M2 2l20 20',
