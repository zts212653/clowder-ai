  ...
  return (
    <section
      ...
      style={{
        ...
        border: isDefaultResponder
          ? '2px solid #D49266'
          : `1px solid ${cat.source === 'runtime' ? '#D9C7EA' : '#F1E7DF'}`,
      }}
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            {isDefaultResponder ? (
              <span className="rounded-full bg-[#FFF3E0] px-2 py-0.5 text-[11px] font-semibold text-[#D49266] flex items-center gap-0.5">
