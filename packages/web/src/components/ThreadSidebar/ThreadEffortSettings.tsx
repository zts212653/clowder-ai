...
interface ThreadEffortSettingsContentProps {
  threadId: string;
}

/** Embedded effort editor for the unified thread settings surface. */
export function ThreadEffortSettingsContent({ threadId }: ThreadEffortSettingsContentProps) {
