    ...
    >
      <label htmlFor="mc-create-title" className="col-span-3">
        ...
        <input
          ...
          placeholder="任务标题"
          className="w-full rounded-lg border border-[var(--console-border-soft)] px-2 py-1.5 text-xs text-cafe outline-none focus:border-[var(--cafe-accent)]"
      ...
      <label htmlFor="mc-create-priority" className="col-span-1">
        ...
        <select
          ...
          className="w-full rounded-lg border border-[var(--console-border-soft)] bg-cafe-surface px-2 py-1.5 text-xs text-cafe outline-none focus:border-[var(--cafe-accent)]"
      ...
      <button
        type="submit"
        disabled={disabled}
        className="col-span-1 rounded-lg bg-cafe px-2 py-1.5 text-xs font-semibold text-[var(--cafe-surface)] disabled:cursor-not-allowed disabled:opacity-40"
