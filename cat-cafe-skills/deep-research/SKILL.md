...
description: >
  ...
  Use when: 技术问题需要多源调查、设计决策需要证据、team lead说"调研"/"research"、需要咨询云端模型。
...
- **Mode B: 云端模型咨询**：本地猫总结背景 → team lead发给云端模型 → 回填结果 → 本地猫综合
...
存：`synthesis.md` → 和team lead讨论 → 落到 ADR
