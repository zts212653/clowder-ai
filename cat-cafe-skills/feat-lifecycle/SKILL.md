...
**讨论结束必须做**：
1. 落盘到 `feature discussion`（含team experience、决策过程、优先级排序）
...
5. 确认产出归档 `feature discussion record/`
...
| Discussion | 采访/开放 → 落盘 → ROADMAP ref | `feature-discussions/` |
| **Design Gate** | **分流 → 确认（UX→team lead/后端→猫猫/架构→两边）** | `feature discussion record/` |
