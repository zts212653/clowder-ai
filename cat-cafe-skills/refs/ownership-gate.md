...
>
> **operator experience**："这是我们自己的家，我们需要有主人翁精神。多问自己：这东西和我们愿景冲突吗？和我们已经有的 feat 冲突吗？是我们需要的吗？技术栈优雅吗？引入的负债是什么呢？"
...
### 必须升级operator（`needs-maintainer-decision`）
...
**48h SLA**：`NEEDS-DISCUSSION` 状态不得超过 48h，超时 → 自动升级operator。
