...
- **Related**: F059（Clowder AI 开源计划 umbrella，done）、F116（开源运营 skill）、F168（社区运营看板）、F238（双向边界对称 / brand-dictionary）
