---
title: "Clowder AI Architecture Diagrams — Handdrawn v2"
created: 2026-05-06
doc_kind: asset-note
...
# Clowder AI Architecture Diagrams — Handdrawn v2

This directory contains the 2026-05-06 handdrawn bitmap variants of the 2026-05-05 Clowder AI architecture diagram set.
...
- Do not treat `codex exec --image <source-png>` as the native F172 image publication path. It creates a nested CLI session and will not publish into the current Clowder AI message bubble.
