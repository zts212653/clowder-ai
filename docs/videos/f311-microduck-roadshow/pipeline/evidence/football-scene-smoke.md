...
- T1 producer：Sol；原请求 `[thread-id]#0001788779964416-000289-4e2258d3`。
- 结果：`[thread-id]#0001788781125224-000347-19a4a4b2`；原调查 coordination `coord-3aa4a28a-4d98-49eb-ad36-4a0e30759f0e` 已 terminal。
