...
| concurrent delivery × cancellation | RESERVED | source audit proves Redis has no shared CAS/Lua across the two read→write paths; Phase A1 does not imply last-writer behavior is valid serialization |
