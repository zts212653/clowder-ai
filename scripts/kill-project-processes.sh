...
# Example: ./scripts/kill-project-processes.sh /path/to/project
#
# If no argument provided, auto-detects project root (parent of scripts/ directory)
...
# Auto-detect project root if no argument provided
if [ -n "${1:-}" ]; then
    PROJECT_PATH="$1"
else
