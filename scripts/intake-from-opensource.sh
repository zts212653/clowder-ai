...
BRAND_EXPECTATIONS=(
  ...
  "packages/api/src/infrastructure/connectors/connector-gateway-bootstrap.ts|must_contain|http://localhost:3001|connector command fallback should use Clowder AI frontend port"
